package com.elara.paxsenix

import android.content.Context
import com.elara.music.betterlyrics.TTMLParser
import com.elara.paxsenix.models.AppleMusicSearchResponse
import com.elara.paxsenix.models.LyricsResponse

import com.elara.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Elara/$appVersion")
                }
