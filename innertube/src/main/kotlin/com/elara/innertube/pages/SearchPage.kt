    ...
    fun toYTItem(renderer: MusicResponsiveListItemRenderer): YTItem? {
        val secondaryLine =
            renderer.flexColumns
                ...
                ?: return null
        return when {
            // CRITICAL: Check isEpisode BEFORE isSong â€” both can match isSong (watchEndpoint or
            ...
            renderer.isEpisode -> {
                ...
                //   Unfiltered: ["Episode", "Â·", "Jan 2025", "Â·", "Podcast Name", "Â·", "1:00:00"]
                //     â†’ secondaryLine = [["Episode"], ["Jan 2025"], ["Podcast Name"], ["1:00:00"]]
                //   Filtered:   ["Jan 2025", "Â·", "Podcast Name"]
                //     â†’ secondaryLine = [["Jan 2025"], ["Podcast Name"]]
                //
