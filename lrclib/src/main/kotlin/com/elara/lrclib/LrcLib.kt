package com.elara.lrclib

import com.elara.lrclib.models.Track
import com.elara.lrclib.models.bestMatchingFor
import com.elara.lrclib.models.bestMatchingForRelaxed
    ...
    suspend fun getLyrics(
        ...
        val res = when {
            duration == -1 -> {
                ...
                // Try with relaxed duration matching (Â±5 seconds instead of Â±2)
        ...
        sortedTracks.forEach { track ->
            ...
            if (count <= 4) {
                if (track.syncedLyrics != null && duration == -1) {
                    ...
                    // Relaxed duration matching (Â±5 seconds)
