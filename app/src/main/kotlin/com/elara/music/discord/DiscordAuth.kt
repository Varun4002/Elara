package com.elara.music.discord
...
import com.elara.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.elara.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.elara.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "Elaradiscord://oauth2/callback"
