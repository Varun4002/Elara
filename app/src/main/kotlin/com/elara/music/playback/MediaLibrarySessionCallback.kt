...
import com.elara.music.constants.AndroidAutoSectionsOrderKey
import com.elara.music.constants.AndroidAutoYouTubePlaylistsKey
import com.elara.music.ui.screens.settings.AndroidAutoSection
import com.elara.music.ui.screens.settings.deserializeSections
import com.elara.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.elara.innertube.pages.HomePage.Section>()
