...
import com.elara.music.db.daos.SpeedDialDao
...
import com.elara.music.db.entities.PlaylistSongMapPreview
...
import com.elara.music.db.entities.SortedSongAlbumMap
import com.elara.music.db.entities.SortedSongArtistMap
import com.elara.music.db.entities.SpeedDialItem
...
val MIGRATION_21_24 =
    object : Migration(21, 24) {
        override fun migrate(db: SupportSQLiteDatabase) {
            // Combine all changes from 21â†’22â†’23â†’24

            // From 21â†’22: Add columns
            try {
