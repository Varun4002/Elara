...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.elara.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.elara.music.widget.LIKE"
        const val ACTION_NEXT = "com.elara.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.elara.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.elara.music.widget.UPDATE_WIDGET"
    }
}
