...
package com.elara.music.widget
...
import com.elara.music.recognition.MusicRecognitionService
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.elara.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
 ...
 *  - 1Ã—4 (minWidth â‰¥ 230dp): Album art + song info + mic button (wide, default)
 *
 * Click behaviour:
 *  - Mic button  â†’ start / stop recognition
 *  - Album art / text area (SUCCESS) â†’ open app on recognition history screen
 *  - Album art / text area (other)   â†’ open app on recognition screen
 */
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    // â”€â”€â”€ Recognition start / stop â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    private fun handleStartRecognition(context: Context) {
        ...
        // Showing a result/error â†’ clear it before starting a new search
        ...
        // No mic permission â†’ open the app so the user can grant it
    ...
    // â”€â”€â”€ Widget update â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€â”€ PendingIntents â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    /** Tap on mic button â†’ start or stop recognition */
    ...
    /**
     * Tap on song info area / album art â†’ always open the recognition screen.
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.elara.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.elara.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.elara.music.widget.recognizer.RESET"
    }
}
