...
import com.elara.music.ui.menu.ExportDialog
import com.elara.music.utils.PlaylistExporter
import com.elara.music.utils.getExportFileUri
import com.elara.music.utils.saveToPublicDocuments
    ...
    if (showExportDialog) {
        ExportDialog(
            ...
            onShare = { format ->
                val playlistSongs =
                    songs.map { s ->
                        com.elara.music.db.entities.PlaylistSong(
                            map =
                                com.elara.music.db.entities.PlaylistSongMap(
                                    songId = s.id,
