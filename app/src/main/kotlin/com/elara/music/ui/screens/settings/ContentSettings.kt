...
import com.elara.music.constants.ContentCountryKey
import com.elara.music.constants.ContentLanguageKey
import com.elara.music.constants.CountryCodeToName
import com.elara.music.constants.EnableBetterLyricsKey
import com.elara.music.constants.EnableKugouKey
import com.elara.music.constants.EnableLrcLibKey
import com.elara.music.constants.EnablePaxsenixKey
import com.elara.music.constants.EnableLyricsPlus
import com.elara.music.constants.HideExplicitKey
import com.elara.music.constants.HideVideoSongsKey
import com.elara.music.constants.HideYoutubeShortsKey
import com.elara.music.constants.LanguageCodeToName
import com.elara.music.constants.LyricsProviderOrderKey
import com.elara.music.constants.ProxyEnabledKey
import com.elara.music.constants.ProxyPasswordKey
import com.elara.music.constants.ProxyTypeKey
import com.elara.music.constants.ProxyUrlKey
import com.elara.music.constants.ProxyUsernameKey
import com.elara.music.constants.QuickPicks
import com.elara.music.constants.QuickPicksKey
import com.elara.music.constants.RandomizeHomeOrderKey
import com.elara.music.constants.SYSTEM_DEFAULT
import com.elara.music.constants.ShowArtistDescriptionKey
import com.elara.music.constants.ShowMostStatsPlaylistsKey
import com.elara.music.constants.ShowArtistSubscriberCountKey
import com.elara.music.constants.ShowMonthlyListenersKey
import com.elara.music.constants.ShowWrappedCardKey
import com.elara.music.constants.TopSize
...
import com.elara.music.ui.component.DraggableLyricsProviderItem
import com.elara.music.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.elara.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.elara.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.elara.music.db.entities.PlaylistEntity(
                        id = com.elara.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.elara.music.db.entities.PlaylistEntity(
                        id = com.elara.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
