...
import com.elara.music.betterlyrics.TTMLParser
...
object LyricsPlusProvider : LyricsProvider {
     ...
     * Elara's extended LRC:
     *
     *   [mm:ss.cc]{agent:v1}line text     â† multi-voice agent tag
     *   <word:startSec:endSec|word:...>   â† word-sync block (Word mode only)
     *   [mm:ss.cc]{bg}bg vocal text       â† first in a consecutive bg run
