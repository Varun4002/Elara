...
package com.elara.music.listentogether
...
import com.elara.music.constants.ListenTogetherAutoApprovalKey
import com.elara.music.constants.ListenTogetherAutoApproveSuggestionsKey
import com.elara.music.constants.ListenTogetherIsHostKey
import com.elara.music.constants.ListenTogetherRoomCodeKey
import com.elara.music.constants.ListenTogetherServerUrlKey
import com.elara.music.constants.ListenTogetherSessionTimestampKey
import com.elara.music.constants.ListenTogetherSessionTokenKey
import com.elara.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.elara.music.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.elara.music.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.elara.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.elara.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.elara.music.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.safeDataStoreEdit { preferences ->
                    preferences[com.elara.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
