...
package com.elara.music.utils

import android.net.ConnectivityManager
import android.net.Uri
import androidx.media3.common.PlaybackException
import com.elara.innertube.NewPipeExtractor
import com.elara.innertube.YouTube
import com.elara.innertube.models.YouTubeClient
import com.elara.innertube.models.YouTubeClient.Companion.ANDROID_CREATOR
import com.elara.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_43_32
import com.elara.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_61_48
import com.elara.innertube.models.YouTubeClient.Companion.ANDROID_VR_NO_AUTH
import com.elara.innertube.models.YouTubeClient.Companion.IOS
import com.elara.innertube.models.YouTubeClient.Companion.IPADOS
import com.elara.innertube.models.YouTubeClient.Companion.MOBILE
import com.elara.innertube.models.YouTubeClient.Companion.TVHTML5
import com.elara.innertube.models.YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER
import com.elara.innertube.models.YouTubeClient.Companion.VISIONOS
import com.elara.innertube.models.YouTubeClient.Companion.WEB
import com.elara.innertube.models.YouTubeClient.Companion.WEB_CREATOR
...
import com.elara.music.utils.YTPlayerUtils.MAIN_CLIENT
import com.elara.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.elara.music.utils.YTPlayerUtils.validateStatus
import com.elara.music.utils.cipher.CipherDeobfuscator
import com.elara.music.utils.cipher.FunctionNameExtractor
import com.elara.music.utils.cipher.PlayerJsFetcher
import com.elara.music.utils.potoken.PoTokenGenerator
import com.elara.music.utils.potoken.PoTokenResult
...
object YTPlayerUtils {
    ...
    // poToken/cipher â€” the most reliable fallback), then WEB_CREATOR, TVHTML5, the ANDROID_VR
    ...
    suspend fun playerResponseForPlayback(
        ...
        for (clientIndex in (startIndex until STREAM_FALLBACK_CLIENTS.size)) {
            ...
            if (clientIndex == -1) {
                ...
                if (client.clientName in disabledStreamClients) {
                    Timber.tag(logTag).d("Skipping MAIN_CLIENT ${client.clientName} â€” disabled in stream sources")
                    continue
                }
                ...
                if (client.clientName in disabledStreamClients) {
                    Timber.tag(logTag).d("Skipping client ${client.clientName} â€” disabled in stream sources")
                    continue
                }
            ...
            if (streamPlayerResponse?.playabilityStatus?.status == "OK") {
                ...
                // try directly, UNLESS this videoId already 403'd on GET (markWebRemixFailed) â€” then
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; Elara cannot recover those without official playback.
