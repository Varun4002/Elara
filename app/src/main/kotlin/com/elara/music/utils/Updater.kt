...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/ElaraGroup/Elara"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Elara.apk" -> "universal" to "foss"
                name == "Elara-with-Google-Cast.apk" -> "universal" to "gms"
