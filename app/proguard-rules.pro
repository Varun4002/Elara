...
# Since Elara is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.elara.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.elara.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.elara.music.utils.cipher.** { *; }
-keep class com.elara.music.utils.potoken.** { *; }
...
## Kotlin Coroutines â€” Reproducible Build Rules
...
-keep class com.elara.music.models.PersistQueue { *; }
-keep class com.elara.music.models.PersistPlayerState { *; }
-keep class com.elara.music.models.QueueData { *; }
-keep class com.elara.music.models.QueueType { *; }
-keep class com.elara.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.elara.music.cast.** { *; }
...
-keep class com.elara.music.recognition.VibraSignature { *; }
-keepclassmembers class com.elara.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.elara.music.listentogether.proto.** { *; }
-keepclassmembers class com.elara.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.elara.shazamkit.models.** { *; }
-keepclassmembers class com.elara.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.elara.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.elara.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.elara.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
